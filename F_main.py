...
##interpretable boosting machine
                ...
                ebm = BoostingMachine(objective='logloss',num_round= 1000,use_gpu =False,learning_rate=0.001,min_max_depth=1,max_max_depth=25,subsample=0.8)
                ebm.fit(X_tr, y_tr)
