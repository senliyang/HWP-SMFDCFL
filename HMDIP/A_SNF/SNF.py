...
def get_syn_sim(k1, k2):
    ...
    microbe_sim1 = np.loadtxt('fun_MS.txt')
    microbe_sim2 = np.loadtxt("cos_MS.txt")
    microbe_sim3 = np.loadtxt("Ga_MS.txt")
    ...
    disease_sim1 = np.loadtxt('sem_DS.txt')
    disease_sim2 = np.loadtxt("cos_DS.txt")
    disease_sim3 = np.loadtxt("Ga_DS.txt")
...
if __name__ == '__main__':
    k1 = 118  # Number of nearest neighbors for microbe similarity
    k2 = 13  # Number of nearest neighbors for disease similarity
